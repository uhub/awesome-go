...
* [ory-am/hydra](https://github.com/ory-am/hydra) - Run your very own low-latency, api-only, cloud native OAuth2 and OpenID Connect provider within minutes. Integrates with any existing user interface and login provider. Written in Google Go.
...
* [therecipe/qt](https://github.com/therecipe/qt) - Qt binding for Go (Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)
