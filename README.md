...
* [ffhelicopter/Go42](https://github.com/ffhelicopter/Go42) - 《Go语言四十二章经》详细讲述了Go语言规范与语法细节以及在开发中常见的误区；通过对标准库包和著名第三方包的实际运用，来启发读者深刻理解Go语言的核心思维，仔细琢磨经典代码设计模式，引领读者进入Go语言开发的更高阶段。
...
* [Jeffail/benthos](https://github.com/Jeffail/benthos) - A stream processor for dull stuff written in Go
...
* [fagongzi/gateway](https://github.com/fagongzi/gateway) - An HTTP API Gateway
...
* [go-jira/go-jira](https://github.com/go-jira/go-jira) - simple jira command line client in Go
...
* [AutoSpotting/AutoSpotting](https://github.com/AutoSpotting/AutoSpotting) - Easiest to adopt spot market automation software, automatically converts your existing on-demand AutoScaling groups to much cheaper spot instances without any launch configuration changes
...
* [cosmos/cosmos-sdk](https://github.com/cosmos/cosmos-sdk) - :chains: Blockchain Application Framework :sparkles:
...
* [imdevlab/chaos](https://github.com/imdevlab/chaos) - A real time messaging service for building  in-app notifications, multiplayer games, chat apps etc
...
* [gogf/gf](https://github.com/gogf/gf) - GoFrame is a modular, full-featured and production-ready application development framework of golang. Providing a series of core components and dozens of practical modules, such as: cache, logging, containers, timer, validator, database orm, etc. Supporting web server integrated with router, cookie, session, logger, configure, template, https, hooks, rewrites and many more features.
* [senghoo/golang-design-pattern](https://github.com/senghoo/golang-design-pattern) - 设计模式 Golang实现－《研磨设计模式》读书笔记
* [banzaicloud/pipeline](https://github.com/banzaicloud/pipeline) - Pipeline enables developers to go from commit to scale in minutes by turning Kubernetes into a feature rich application platform integrating CI/CD, centralized logging, monitoring, enterprise-grade security, autoscaling and more.
...
* [adtac/autovpn](https://github.com/adtac/autovpn) - THIS PROJECT IS UNMAINTAINED.
...
* [changkun/go-under-the-hood](https://github.com/changkun/go-under-the-hood) - 📚 Go Under The Hood: A Source Code Study of Go (1.13alpha, WIP)
...
* [nntaoli-project/GoEx](https://github.com/nntaoli-project/GoEx) - Exchange Rest And WebSocket API For Golang  Wrapper support okcoin,okex,huobipro,hbdm,coinex,poloniex,bitfinex,bitstamp,binance,kraken,bithumb,zb,hitbtc,fcoin
...
* [geziyor/geziyor](https://github.com/geziyor/geziyor) - Geziyor, a blazing fast web crawling & scraping framework for Go
...
* [DATA-DOG/godog](https://github.com/DATA-DOG/godog) - Cucumber for golang
...
* [ortuman/jackal](https://github.com/ortuman/jackal) - An XMPP server written in Go (Golang).
...
* [imdevlab/flap](https://github.com/imdevlab/flap) - http://flap.dev -  a modern pub/sub platform, can deliver messages to App/Web/Server client
...
* [documize/community](https://github.com/documize/community) - Open source Confluence alternative for internal & external docs built with Golang + EmberJS
* [dougblack/sleepy](https://github.com/dougblack/sleepy) - rest for go
* [unidoc/unidoc](https://github.com/unidoc/unidoc) - UniDoc is a PDF library for creating and processing PDF files in Golang (pure go)
...
* [micro/go-config](https://github.com/micro/go-config) - A dynamic config framework
...
* [FlashBoys/go-finance](https://github.com/FlashBoys/go-finance) - :warning: Deprecrated in favor of https://github.com/piquette/finance-go :warning:
...
* [h2non/gentleman](https://github.com/h2non/gentleman) - Full-featured, plugin-oriented, extensible HTTP client toolkit for Go
...
* [cristim/autospotting](https://github.com/cristim/autospotting) - Automatically convert your existing AutoScaling groups to up to 90% cheaper spot instances with minimal(often zero) configuration changes
...
* [MaxHalford/gago](https://github.com/MaxHalford/gago) - 🍀 Genetic algorithm library
...
* [fossas/fossa-cli](https://github.com/fossas/fossa-cli) - Fast, portable and reliable dependency analysis for any codebase.  Supports license reporting, large monoliths and 20+ build systems (go, npm, maven, gems, etc...).
...
* [jsix/go2o](https://github.com/jsix/go2o) - Golang基于DDD的o2o的业务模型及基础
...
* [src-d/gitquery](https://github.com/src-d/gitquery) - SQL interface to Git repositories, written in Go.
...
* [C0nstantin/go-webmoney](https://github.com/C0nstantin/go-webmoney/) - api for working webmoney xml interfaces
