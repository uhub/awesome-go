...
* [Skeleton](https://github.com/gadelkareem/skeleton) - A complete Golang and Nuxt boilerplate for your project with backend API, frontend, tests and CI/CD pipelines.
