...
* [ory-am/hydra](https://github.com/ory-am/hydra) - Run your very own low-latency, api-only, cloud native OAuth2 and OpenID Connect provider within minutes. Integrates with existing authentication mechanisms. Written in Google Go.
...
* [pilu/fresh](https://github.com/pilu/fresh) - [ABANDONED] Build and (re)start go web apps after saving/creating/deleting source files.
